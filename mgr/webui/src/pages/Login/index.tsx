  ...
  return (
    <span className={styles.appMark} aria-hidden="true">
      <svg viewBox="0 0 48 48">
        <defs>
          <linearGradient id="loginMarkGradient" x1="6" x2="42" y1="4" y2="44">
            <stop stopColor="#29d99e" />
            <stop offset="1" stopColor="#19bd80" />
          </linearGradient>
        </defs>
        <rect width="48" height="48" rx="10" fill="url(#loginMarkGradient)" />
        <path
          ...
          fill="#fff"
        />
        <path d="M19 19h9.6M19 23.5h9.6M19 28h6.2" stroke="#1cbd82" strokeLinecap="round" strokeWidth="2.4" />
        <path d="m30.2 28.5 5.6 5.5 3.7-4" fill="none" stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.6" />
      </svg>
    </span>
  );
}
  ...
  return (
    <section className={styles.artwork} aria-hidden="true">
      ...
      <svg className={styles.artworkSvg} viewBox="0 0 620 430">
        <defs>
          <linearGradient id="loginScreenBlue" x1="136" x2="438" y1="96" y2="282">
            <stop stopColor="#89adff" />
            <stop offset="1" stopColor="#4d7cf2" />
          </linearGradient>
          <linearGradient id="loginPaperFront" x1="390" x2="556" y1="138" y2="318">
            <stop stopColor="#fff" />
            <stop offset="1" stopColor="#edf6ff" />
          </linearGradient>
          <linearGradient id="loginPaperFold" x1="526" x2="572" y1="130" y2="176">
            <stop stopColor="#4dd8e8" />
            <stop offset="1" stopColor="#87e7f1" />
          </linearGradient>
          <filter id="loginArtShadow" x="-30%" y="-30%" width="170%" height="170%">
        ...
        <path d="M132 288h318l-64 38H70l62-38Z" fill="#dceaff" filter="url(#loginArtShadow)" />
        <path d="m154 272 9-176c.3-5.2 4.7-9.2 10-8.9l258 14.2a9.4 9.4 0 0 1 8.8 9.9L432 278l-278-6Z" fill="url(#loginScreenBlue)" filter="url(#loginArtShadow)" />
